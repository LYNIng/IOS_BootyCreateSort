...
public partial class SuperCoinElement : MonoCompositeSingleton<SuperCoinElement>, IMsgObj
{
    ...
    protected override void OnAwake()
    {
        ...
        tmpCoin = GlobalSingleton.SuperCoin;
        txtValue.text = tmpCoin.ToPriceStr();
    ...
    int tmpCoin;
    [CmdCallback((ushort)GameEvent.RefreshSuperCoin)]
    private void OnRefresh()
    {
        int dst = GlobalSingleton.SuperCoin - tmpCoin;
        tmpCoin = GlobalSingleton.SuperCoin;
        int tmp = GlobalSingleton.SuperCoin;
    ...
    private void SetEffect(int dst)
    {
        ...
        effect.GetComponentInChildren<TextMeshProUGUI>().text = dst > 0 ? $"+{v.ToPriceStr()}" : $"-{v.ToPriceStr()}";
